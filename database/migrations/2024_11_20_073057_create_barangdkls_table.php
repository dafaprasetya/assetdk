...
class CreateBarangdklsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('barangdkls', function (Blueprint $table) {
                ...
                $table->string('jenis_asset')->default('DKL');
    ...
    {
        Schema::dropIfExists('barangdkls');
    }
}
